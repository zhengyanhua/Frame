...
- (void)removeMBProgressHudInManaual
{
    ...
    [MBProgressHUD hideHUDForView:[self promptingTopView] animated:YES];
}
//  等待视图
- (MBProgressHUD *)showHudWaitingView:(NSString *)prompt
{
    ...
    hud.bezelView.color = [UIColor flashColorWithRed:0 green:0 blue:0 alpha:0.8];
...
- (MBProgressHUD *)showHudAuto:(NSString *)text andDuration:(CGFloat)duration
{
    return [self showMBHudView:text customerView:nil removeAuto:YES andDuration:duration];
}

- (MBProgressHUD *)showMBHudView:(NSString *)text customerView:(UIView *)customerView removeAuto:(BOOL)autoremove andDuration:(CGFloat)duration
{
    //    [MBProgressHUD hideAllHUDsForView:[self promptingTopView] animated:YES];
    [MBProgressHUD hideHUDForView:[self promptingTopView] animated:YES];
    MBProgressHUD *hud=[MBProgressHUD showHUDAddedTo:[self promptingTopView] animated:YES];
